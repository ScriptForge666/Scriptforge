...
(
echo // This file is auto-generated by start.bat, do not edit it manually.
echo export module Scriptforge.AntiDebug.Random;
...
) >"%ProjectDir%Scriptforge.AntiDebug.Random.ixx" 2>nul
